...
namespace proteinDetect
{
    class mostRecentFile
    {
		...
		private void _refreshRecentFilesMenu()
		{
			...
			tSI = this.ParentMenuItem.DropDownItems.Add("清除列表");
        ...
        public mostRecentFile(ToolStripMenuItem parentMenuItem, string nameOfProgram, Action<object, EventArgs> onRecentFileClick, Action<object, EventArgs> onClearRecentFilesClick = null)
		{
